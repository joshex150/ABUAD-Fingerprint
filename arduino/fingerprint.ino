...
const char *ssid = "Joshua";  //ENTER YOUR WIFI SETTINGS
const char *password = "asdfqwerpeng";
WiFiClientSecure client;
//************************************************************************
String postData ; // post array that will be send to the website
String link = "https://abuad-fingerprint.000webhostapp.com/getdata.php"; //computer IP or the server domain
...
void SendFingerprintID( int finger ){
  ...
  http.addHeader("Access-Control-Allow-Origin", "*");    //Specify Access-Control-Allow-Origin header
...
void ChecktoDeleteID(){
  ...
  // Post methode
  client.setInsecure();  // Ignore SSL certificate verification
  http.begin(client, link); //initiate HTTP request, put your Website URL or Your Computer IP ; //initiate HTTP request, put your Website URL or Your Computer IP 
  http.addHeader("Content-Type", "application/x-www-form-urlencoded");    //Specify content-type header
  http.addHeader("Access-Control-Allow-Origin", "*");    //Specify Access-Control-Allow-Origin header
