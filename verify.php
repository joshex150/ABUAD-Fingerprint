  ...
  <main>
    <section>
      ...
      <form action="verify_code.php" method="post">
        ...
        <input placeholder="enter verification code" type="text" id="verify" name="verify" required="" />

        <button title="" id="verify" name="verify" type="submit" data-original-title="Click Here to Sign In">
          Verify code
        </button>
      </form>
    </section>
